...
class AdminView(tk.Frame):
    ...
    def build_workers_manage_screen(self):
        ...
        ttk.Button(row1, text="Dodaj użytkownika (pracownik)")\
            .pack(side="left", padx=5, pady=10)

        ttk.Button(row1, text="Edytuj użytkownika (pracownik)")\
            .pack(side="left", padx=5, pady=10)

        ttk.Button(row1, text="Usuń użytkownika (pracownik)")\
            .pack(side="left", padx=5, pady=10)
...
#tymczasowo nie dziala(pominąć bo jeszcze robie)
    def register(self):
